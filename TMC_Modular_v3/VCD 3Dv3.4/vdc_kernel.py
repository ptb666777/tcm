...
class UniverseState:
    def __init__(self, N):
        ...
        # Current simulation epoch - managed by MatterStateModule
        self.epoch = 'plasma_hot'
...
class Kernel:
    ...
    def _update_epoch(self, step):
        """
        Epoch and temperature are now managed by MatterStateModule.
        Kernel just ensures initial epoch is set correctly.
        MatterStateModule must be registered first.
        """
        pass  # MatterStateModule handles this
